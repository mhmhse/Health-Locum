...
<html>
    <head>
        ...
        <!-- Title -->
        <title>..:: Medline | View Payments ::..</title>
...
$response =  getHospitalDetailsById($cn,$payment['hospital_id']);
...
$doctor_name = $doctor_details['surname'] . "  " . $doctor_details['other_name'];
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" dt-body-left"><a href="../assignment/view-single-assignment.php?assignment_id=<?php echo $payment['assignment_id']; ?>">go to assignment</a></td>
                                        <td class=" dt-body-left"><?php echo $payment['doctor_approved_status']; ?></td>
                                        <td class=" dt-body-left"><?php echo $payment['amount_paid_hospital']; ?></td>
                                        <td class=" dt-body-left"><?php echo $payment['amount_paid_doctor']; ?></td>
                                       ...
                                       <!--  <td>
                                        <a href="../payment/payment.php?payment_id=<?php echo $payment['id']; ?>" class="waves-effect waves-button"><span><i class="fa fa-credit-card"></i></span><p></p><span class="arrow"></span></a>
                                        </td>
 -->
