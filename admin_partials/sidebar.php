            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo $_SESSION['admin_login_name']; ?><br><small>Administrator</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="../dashboard/index.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                        <li><a href="../doctors/index.php" class="waves-effect waves-button"><span><i class="fa fa-user-md fa-2x"></i></span><p>Providers</p></a></li>
                        <!-- <li><a href="index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Facilities</p></a></li> -->
                        <li><a href="../hospital/index.php" class="waves-effect waves-button"><span> <i class="fa fa-hospital-o fa-2x"></i></span><p>Facilities</p></a></li>

                           <li><a href="../application/index.php" class="waves-effect waves-button"><span> <i class="fa fa-file-text-o fa-2x"></i></span><p>Application</p></a></li>
                       
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span><i class="fa fa-bullhorn fa-2x"></i></span><p>Request</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="../request/view-request.php">View Request</a></li>
                                <li><a href="../request/post-request.php">Post Request</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span><i class="fa fa-briefcase fa-2x"></i></span><p>Assignment</p><span class="arrow"></span></a>

                        <ul class="sub-menu">
                                <li><a href="../assignment/index.php">View Assignment</a></li>
                                <li><a href="../assignment/request-manager.php">Request Manager</a></li>
                            </ul>

                        </li>


                        <li><a href="../payment/index.php" class="waves-effect waves-button"><span><i class="fa fa-money fa-2x"></i></span><p>Account</p></a></li>
                        <li><a href="../match/index.php" class="waves-effect waves-button"><span><i class="fa fa-check-circle-o fa-2x"></i></span><p>Match</p></a></li>
                        <li><a href="../../logout.php" class="waves-effect waves-button"><span><i class="fa fa-sign-out fa-2x"></i></span><p>Log out</p></a></li>
