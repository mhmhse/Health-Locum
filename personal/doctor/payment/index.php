        ...
        <div id="page-content" class="content-about"><!-- start content -->
                ...
                <div class="container"> <!-- container -->
                        ...
                        <div class="col-md-12">
                             ...
                             $sql = "SELECT * FROM payment WHERE doctor_id = '".$doctor_login_id."' and not amount_paid_doctor = '' order by id desc";
...
$hospital_name = $response['hospital_name'];
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" dt-body-left"><?php echo $payment['amount_expected_doctor']; ?></td>
                                        ...
                                        <td class=" dt-body-left"><?php echo $payment['admin_approved_status']; ?></td>
