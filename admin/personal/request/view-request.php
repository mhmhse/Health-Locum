...
$hospital_name = $response['hospital_name'];
                                ?>
                                    ...
                                    <tr>
                                        <td><img src="../../../personal/hospital/logo/<?php echo $logo.".jpg"; ?>" width="50" height="30"></td>
                                        <td class=" dt-body-left"><?php echo $hospital_name; ?></td>
                                        <td class=" dt-body-center"><?php echo $request['num_of_provider']; ?></td>
                                        <td class=" dt-body-left"><?php echo $request['specialization']; ?></td>
                                        <td class=" dt-body-left"><?php echo $request['state']; ?></td>
                                        <td class=" dt-body-center"><?php echo $request['job_type']; ?></td>
                                        <td class=" dt-body-center"><?php echo $request['date_posted']; ?></td>
                                        
                                          <td class=" dt-body-center"><?php echo $request['taken']; ?></td>
                                     <!--  <td class=" dt-body-center"><span><i class="fa fa-info"></i></span></td> -->
                                            <td>
                                        <a href="view-single-request.php?request_id=<?php echo base64_encode($request['id']); ?>" class="waves-effect waves-button"><span><i class="fa fa-info"></i></span><p></p><span class="arrow"></span></a>
                                            </td>
        ...
        <script type="text/javascript" src="view-request.js"></script>
