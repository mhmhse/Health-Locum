...
if($email == "" || $activation_key == "" || $user_type == "user_type"){
...
<html lang="en">
  <head>
    ...
    <title>..:: Medline | Forgot Password ::..</title>
    ...
    <body>
    	...
    	<div class="main-page-title"><!-- start main page title -->
			<div class="container">
				<div class="page-title"  style="font-weight: normal;">Change Password.</div>
			</div>
                    ...
                    <div class="col-md-5">
                        <div class="form-singin-container">
                            <form role="form">
                                ...
                                <input type="hidden" value="<?php echo $email; ?>" id="hid_email">
                                <input type="hidden" value="<?php echo $activation_key; ?>" id="hid_activation">
                                <input type="hidden" value="<?php echo $user_type; ?>" id="hid_user_type">
                             ...
                             -->
                                ...
                                <div class="form-group">
                                <input type="password" class="form-control input-form" placeholder="Password" id="txt_password">
                                <div class="singin-aksen"></div>                                
                                </div>
                            

                                <div class="form-group">
                                <input type="password" class="form-control input-form" placeholder="Confirm Password" id="txt_conf_password">
                                <div class="singin-aksen"></div>                                
                                <!-- </div> -->
                            
<!-- 
                                <div class="form-group">
                                    <select id="registration_type" class="form-control input-form">
                                ...
                                <button class="btn btn-default" id="btn_change_password">Change Password</button>
...
<?php include('partials/footer.php');?>
    ...
    <?php include('partials/scripts.php');?>
     <script type="text/javascript" src="password-util.js"></script>
</body>
</html>
